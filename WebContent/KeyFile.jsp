...
<div id="templatemo_middle_wrapper">
	...
	if(key.equals("1"))
	{
		...
		alert("Wrong Key Pleage try again");		</script>
		<%
	}
	else
	{
	...
	<form name="form1" action="DBFileDownloadServlet" method="post">
		<table align="center" class="fileup" border="1"
			cellspacing="10" cellpadding="11"
			style="font-family: monotype corsiva; font-size: 22px; font-weight: bold">
			<thead>
				<tr bgcolor="#FAEBD7">
					<th colspan="2">Key For File</th>
				...
				<tr>
					...
					<td class="col-md-2"><label for="txt_Uname"><h3><%=(String)session.getAttribute("strFileName") %></h3> </label></td>
					</tr>
					<tr>
					<td class="col-md-2"><label for="txt_Uname"><h3>Enter Key</h3> </label></td>
					<td><input type="text" name="Keyfile" value="<%=key%>" readonly="readonly"></td>
				</tr>
				<tr>
