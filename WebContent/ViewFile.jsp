	...
	<div id="templatemo_middle" align="center">
 	 ...
 	 <form enctype="multipart/form-data"  role="form" action="Download">
         ...
         //String username="suhas";
            ResultSet rs =statement.executeQuery("select * from fileinfo where user='"+username+"'");
            if(rs.next()){
	        	//break;  
	        	ResultSet resultset =statement.executeQuery("select * from fileinfo where user='"+username+"'");
            	%>
				<table class="table table-responsive table-bordered" style="width: 100%">
	       <tr>
			<td class="col-md-2"><label for="txt_Uname"><h3>File Name</h3> </label></td>
			<td class="col-md-2"><label for="txt_Uname"><h3>File Size</h3> </label></td>
			<td class="col-md-2"><label for="txt_Uname"><h3>File Time</h3> </label></td>
		   </tr>
