	...
	<div id="templatemo_middle" align="center">
        ...
        <div id="templatemo_content" align="center" style="width: 100%">
          ...
          String username=(String)session.getAttribute("unam");
            ...
            ResultSet rs =statement.executeQuery("select * from access  where touser='"+username+"'") ;
          //  ResultSet rs =statement.executeQuery("select filename from access  where touser='"+username+"'") ;
            if(rs.next()){
	        	//break;  
	        	ResultSet resultset =statement.executeQuery("select * from access  where touser='"+username+"'");
        		%>  
				<table border="1" style="width: 75%">
	       <tr>
	       <td class="col-md-2"><label for="txt_Uname"><h3>Owner Email ID</h3> </label></td>
           ...
           <td> <%= resultset.getString("fromuser") %> </td>
              <td> <%= resultset.getString("filename") %> </td>
               ...
               <td> <a href="AccessServlet?filenamedb=<%=resultset.getString("filename")%>&email=<%=resultset.getString("fromuser")%>"><input type="button" name="Download" value="Download" class="btn btn-info"></a></td>
                         </tr>
       		  <% 
             } 
